 ...
 * 월간보고 엑셀 생성기.
 *
 * WeeklyExcelGenerator와 대응 — 주간 실적은 WeeklyExcelGenerator, 월간 실적은 이 클래스가 담당한다.
 *
 * 구조 (WeeklyExcelGenerator와 동일):
...
public class MonthlyExcelGenerator {
  ...
  /** 전체 합산 탭 생성 — 모든 카테고리 티켓 합산, 기한 오름차순 → 카테고리 순 정렬. */
  ...
  /** 스타일 — WeeklyExcelGenerator와 동일한 팔레트. */
