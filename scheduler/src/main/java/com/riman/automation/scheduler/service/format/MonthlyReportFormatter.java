 ...
 *
 * WeeklyReportFormatter와 대응 — 주간은 전주 완료/분기 진행중, 월간은 대상 월 완료/분기 진행중을 렌더링한다.
 *
 * 구조:
 *   [헤더 패널] 기간 / 분기 / 전체 건수
 ...
 *   ▼ [회원]  완료 1 / 진행 4
 *
 * WeeklyReportFormatter와 동일한 렌더링 규칙을 적용한다.
 * 줄바꿈 방지: 날짜/이슈키 셀을 span(display:inline-block)으로 감싼다.
 */
