 ...
 * Lambda는 UTC로 실행되므로, 보고서 기준 날짜 계산은 반드시 이 클래스를 사용해야 한다.
 */
public final class DateTimeUtil {
  ...
  /**
   * "yyyy-MM-dd" 형식의 문자열을 LocalDate로 파싱한다. null 또는 파싱 실패 시 null 반환.
   */
  ...
  /**
   * LocalDate KST 00:00을 RFC3339 UTC 문자열로 변환한다 (Google Calendar API용).
   */
