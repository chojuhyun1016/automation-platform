 ...
 * Calendar API 쿼타 초과 같은 운영 이슈 발생 시 지정된 Slack 채널로 알림을 전송한다.
 * MONITORING_SLACK_CHANNEL 또는 SLACK_BOT_TOKEN 환경변수가 비어 있으면 비활성 상태로 동작한다.
 */
@Slf4j
